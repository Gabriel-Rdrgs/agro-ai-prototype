...
Infraestrutura: Vercel (Front + AI), Render (Node API)


🚀 Como Rodar Localmente
Pré-requisitos: Node.js v18+, Python 3.10+, PostgreSQL

Backend Node.jsBashcd backend
npm install
# Crie .env com DATABASE_URL e JWT_SECRET
npx prisma migrate dev --name init
npx prisma db seed
npm run dev  # http://localhost:3001
AI Service (Python)Bashcd ai-service
python -m venv venv
