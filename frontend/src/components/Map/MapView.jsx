              ...
              >
                <Popup maxWidth={350} minWidth={250} autoPanPadding={[50, 50]}>
                  <div style={{padding:'8px',fontFamily:theme.font,background:`${theme.colors.background}F2`,color:theme.colors.textPrimary,borderRadius:'12px',boxShadow:theme.colors.cardGlow}}>
                    ...
                    <div style={{padding:'8px',background:opp.riskLevel===1?'#22c55e20':opp.riskLevel===2?`${theme.colors.secondary}20`:'#fee2e2',borderLeft:`4px solid ${opp.riskLevel===1?'#22c55e':opp.riskLevel===2?theme.colors.secondary:'#dc2626'}`,borderRadius:'4px',marginBottom:'10px'}}><span style={{fontSize:'12px',fontWeight:'600',color:theme.colors.textPrimary}}>⚠️ Risco: {opp.risk}</span></div>
